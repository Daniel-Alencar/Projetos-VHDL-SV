...
## Header P2
set_property -dict {PACKAGE_PIN T3 IOSTANDARD LVCMOS33} [get_ports SDA]; #IO_0_34 - P2_3
set_property -dict {PACKAGE_PIN U2 IOSTANDARD LVCMOS33} [get_ports SCL]; #IO_L2P_T0_34 - P2_4
...
## Board LED D2
set_property -dict {PACKAGE_PIN A18 IOSTANDARD LVCMOS33} [get_ports led_D2]; # IO_L17P_T2_16 - i9+_LED_D2
...
## Header P2
set_property -dict {PACKAGE_PIN T3 IOSTANDARD LVCMOS33} [get_ports led[0]]; #IO_0_34 - P2_3
set_property -dict {PACKAGE_PIN U2 IOSTANDARD LVCMOS33} [get_ports led[1]]; #IO_L2P_T0_34 - P2_4
set_property -dict {PACKAGE_PIN V2 IOSTANDARD LVCMOS33} [get_ports led[2]]; #IO_L2N_T0_34 - P2_5
set_property -dict {PACKAGE_PIN W1 IOSTANDARD LVCMOS33} [get_ports led[3]]; #IO_L5P_T0_34 - P2_6
set_property -dict {PACKAGE_PIN AA1 IOSTANDARD LVCMOS33} [get_ports led[4]]; #IO_L7P_T1_34 - P2_7
set_property -dict {PACKAGE_PIN W2 IOSTANDARD LVCMOS33} [get_ports led[5]]; #IO_L4P_T0_34 - P2_9
set_property -dict {PACKAGE_PIN AB2 IOSTANDARD LVCMOS33} [get_ports led[6]]; #IO_L8N_T1_34 - P2_12
set_property -dict {PACKAGE_PIN AB3 IOSTANDARD LVCMOS33} [get_ports led[7]]; #IO_L8P_T1_34 - P2_13
set_property -dict {PACKAGE_PIN W4 IOSTANDARD LVCMOS33} [get_ports led[8]]; #IO_L12N_T1_MRCC_34 - P2_14
set_property -dict {PACKAGE_PIN Y6 IOSTANDARD LVCMOS33} [get_ports led[9]]; #IO_L18P_T2_34 - P2_15
...
## Header P4
#set_property -dict {PACKAGE_PIN AB21 IOSTANDARD LVCMOS33} [get_ports P4_3]; #IO_L10P_T1_D14_14 - P4_3
#set_property -dict {PACKAGE_PIN U17 IOSTANDARD LVCMOS33} [get_ports P4_4]; #IO_L18P_T2_A12_D28_14 - P4_4
...
## Header P6
#set_property -dict {PACKAGE_PIN L4 IOSTANDARD LVCMOS33} [get_ports P6_3]; #IO_L18N_T2_35 - P6_3
#set_property -dict {PACKAGE_PIN G4 IOSTANDARD LVCMOS33} [get_ports P6_4]; #IO_L12N_T1_MRCC_35 - P6_4
#set_property -dict {PACKAGE_PIN G3 IOSTANDARD LVCMOS33} [get_ports P6_5]; #IO_L11N_T1_SRCC_35 - P6_5
#set_property -dict {PACKAGE_PIN K2 IOSTANDARD LVCMOS33} [get_ports P6_6]; #IO_L9P_T1_DQS_AD7P_35 - P6_6
#set_property -dict {PACKAGE_PIN M1 IOSTANDARD LVCMOS33} [get_ports P6_7]; #IO_L15P_T2_DQS_35 - P6_7
#set_property -dict {PACKAGE_PIN K1 IOSTANDARD LVCMOS33} [get_ports P6_9]; #IO_L7P_T1_AD6P_35 - P6_9
#set_property -dict {PACKAGE_PIN H3 IOSTANDARD LVCMOS33} [get_ports P6_12]; #IO_L11P_T1_SRCC_35 - P6_12
#set_property -dict {PACKAGE_PIN V5 IOSTANDARD LVCMOS33} [get_ports P6_13]; #IO_L16N_T2_34 - P6_13
#set_property -dict {PACKAGE_PIN U6 IOSTANDARD LVCMOS33} [get_ports P6_14]; #IO_L16P_T2_34 - P6_14
#set_property -dict {PACKAGE_PIN T6 IOSTANDARD LVCMOS33} [get_ports P6_15]; #IO_L17N_T2_34 - P6_15
#set_property -dict {PACKAGE_PIN P5 IOSTANDARD LVCMOS33} [get_ports P6_16]; #IO_L21P_T3_DQS_35 - P6_16
#set_property -dict {PACKAGE_PIN U7 IOSTANDARD LVCMOS33} [get_ports P6_17]; #IO_25_34 - P6_17
#set_property -dict {PACKAGE_PIN U5 IOSTANDARD LVCMOS33} [get_ports P6_18]; #IO_L14N_T2_SRCC_34 - P6_18
#set_property -dict {PACKAGE_PIN U1 IOSTANDARD LVCMOS33} [get_ports P6_19]; #IO_L1N_T0_34 - P6_19
#set_property -dict {PACKAGE_PIN J1 IOSTANDARD LVCMOS33} [get_ports P6_22]; #IO_L7N_T1_AD6N_35 - P6_22
